...
//@Configuration
//@EnableKafka
//public class KafkaAlphaConsumerConfig {
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(KafkaAlphaConsumerConfig.class.getCanonicalName());
...
//
//    @Value("${kafkaTest.bootstrap.server.config}")
//    private String bootstrapServers;
//
//    @Value("${security.protocol.config}")
//    private String securityProtocol;
//
//    @Value("${kafkaTest.ssl.truststore.location.config}")
//    private String sslTruststoreLocation;
//
//    @Value("${ssl.truststore.password.config}")
//    private String sslTruststorePassword;
//
//    @Value("${kafkaTest.ssl.keystore.location.config}")
...
//
//    @Value("${kafkaTest.group.id.config}")
...
//
//    @Bean
//    public Map<String, Object> consumerConfigsAlpha() {
//        Map<String, Object> props = new HashMap<>();
//
//        try {
//            LOGGER.info("DS-ALPHA-CONSUMER | KafkaConsumerConfig Started.");
...
//            LOGGER.info("DS-ALPHA-CONSUMER | KafkaConsumerConfig Completed.");
//        } catch(Exception ex) {
//            LOGGER.error("DS-ALPHA-CONSUMER | Exception in KafkaConsumerConfig method ex:{}",ex.getMessage(),ex);
//        }
//        return props;
//    }
//
//    @Bean
//    public ConsumerFactory<String, String> AlphaConsumerFactory() {
//        return new DefaultKafkaConsumerFactory<>(consumerConfigsAlpha());
//    }
//
//    @Bean
//    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> alphaKafkaListenerContainerFactory() {
//        ConcurrentKafkaListenerContainerFactory<String, String> factory =
//                new ConcurrentKafkaListenerContainerFactory<>();
//        factory.setConsumerFactory(AlphaConsumerFactory());
//        return factory;
//    }
//}
